...
//                              itemCount: coronaProvider?.Positif?.length ?? 0,
//                              itemBuilder: (context, index) {
//                                return Column(
//                                  crossAxisAlignment: CrossAxisAlignment.start,
//                                  children: <Widget>[
//                                    Text(
//                                      '${coronaProvider.Positif[index].confirmed} ${coronaProvider.Positif[index].provinceState} ${coronaProvider.Positif[index].countryRegion}',
//                                      style: GoogleFonts.poppins(
//                                          color: Colors.white),
//                                    ),
//                                    Divider(
